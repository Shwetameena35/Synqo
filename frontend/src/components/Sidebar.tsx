...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 lg:static lg:z-auto h-full lg:h-[calc(100vh-3.5rem)] flex border-r border-[#2B2B2B] select-none bg-[#141414] transition-transform duration-300 ease-in-out ${isMobileOpen ? 'translate-x-0 shadow-2xl' : '-translate-x-full lg:translate-x-0'
          }`}
      >
